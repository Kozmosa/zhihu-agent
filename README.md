...
点击右下角的 **问知境** 悬浮球可展开问答浮窗，边阅读边向当前资料提问。Enter 发送，Shift+Enter 换行，Esc 收起；答案下可展开引用。收起后再次打开保留当前资料的对话显示，切换资料会清空记录。每条问题独立依据已导入资料回答，不会把之前的聊天记录发送给模型。手机端可展开“我的资料”选择文章。
